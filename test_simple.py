#!/usr/bin/env python3
"""
Simple test script to verify the dummy database setup is working correctly.
"""

import sqlite3
from sqlite_postgres_utils import run_sql_query
from tools_simple import run_rag_pipeline, process_uploaded_data
import pandas as pd
...
def main():
    ...
    if db_ok:
        ...
        print("1. Backend API: python server_simple.py")
        print("2. Frontend UI: streamlit run app.py")
        print("3. Or use: uvicorn server_simple:app --reload")
    else:
